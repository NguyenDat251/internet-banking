...
function menu({ match }) {
  return (
    <nav className="custom-navbar navbar-expand navbar-light bg-color">
      ...
      <NavDropdown
        title={<span className="text-white divider-vertical">Thông tin tài khoản</span>}
      ...
      <NavDropdown
        ...
        <NavDropdown.Item href="#action/3.2">Chuyển tiền tới ngân hàng khác</NavDropdown.Item>
      </NavDropdown>
      <NavDropdown
